module uim.cake.commands.server;
...
class ServerCommand : Command {
   mixin(CommandThis!("ServerCommand"));
     ...
     */
    protected void startup(Arguments commandArguments, ConsoleIo aConsoleIo) {
        ...
        if (commandArguments.getOption("document_root")) {
           _documentRoot = (string)commandArguments.getOption("document_root");
        }
  ...
  int execute(Arguments commandArguments, ConsoleIo aConsoleIo) {
        ...
        phpBinary = (string)enviroment("PHP", "php");
