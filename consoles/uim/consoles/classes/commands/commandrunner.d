...
class CommandRunner : IEventDispatcher {
     ...
     * Params:
     * \UIM\Console\ConsoleIo aConsoleIo The IO wrapper for the created shell class.
     ...
     */
    protected ICommand getCommand(ConsoleIo aConsoleIo, CommandCollection commands, string commandName) {
     ...
     * Params:
     * \UIM\Console\CommandCollection commands The command collection to check.
     * @param \UIM\Console\ConsoleIo aConsoleIo ConsoleIo object for errors.
     * @param string name The name from the CLI args.
     */
    protected string resolveName(CommandCollection commands, ConsoleIo aConsoleIo, string aName) {
        if (!name) {
