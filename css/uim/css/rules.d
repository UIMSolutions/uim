...
class DCSSRules : DCSSObj {
	...
	O rules(this O)(DCSSRule[] someRules) { _rules ~= someRules; return cast(DO)this; }	
	O rules(this O)(DCSSRules someRules) { _rules ~= someRules.rules; return cast(DO)this; }	
	...
	/// Adding CSS rules
	O add(this O)(DCSSRules aRules) { _rules ~= aRules.rules; return cast(DO)this; }
	O add(this O)(DCSSRule aRule) { _rules ~= aRule; return cast(DO)this; }
	O add(this O)(DCSSMedia aRule) { _rules ~= aRule; return cast(DO)this; }

	O rule(this O)(DCSSRule aRule) { _rules ~= aRule; return cast(DO)this; }
	O rule(this O)(string aSelector, string name, string value) { _rules~=CSSRule(aSelector, name, value); return cast(DO)this; }
	O rule(this O)(string aSelector, string[string] someDeclarations) { _rules~=CSSRule(aSelector, someDeclarations); return cast(DO)this; }

	O opCall(this O)(string aSelector, string name, string value) { _rules~=CSSRule(aSelector, name, value); return cast(DO)this; }
	O opCall(this O)(string aSelector, string[string] someDeclarations) { _rules~=CSSRule(aSelector, someDeclarations); return cast(DO)this; }
