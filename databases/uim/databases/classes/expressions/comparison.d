...
class ComparisonExpression : IExpression, IField {
     ...
     * position.
     * Params:
     * \UIM\Database\IExpression|iterable  someValues The rows to insert
     */
    protected array _collectExpressions(IExpression|iterable  someValues) {
        if (cast(IExpression)someValues ) {
            return [someValues, []];
        }
    }
    protected array _collectExpressions(iterable  someValues) {
