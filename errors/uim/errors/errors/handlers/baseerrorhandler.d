...
**********************************************************************************************************/
module errors.uim.errors.errors.handlers.baseerrorhandler;
...
abstract class DERRErrorHandler {
    ...
    bool initialize() {}
      ...
      _defaultConfig["log"] = true;
      _defaultConfig["trace"] = false;
      _defaultConfig["skipLog"] = Jso.emptyArray;
      _defaultConfig["errorLogger"] = "ErrorLogger::class";
    }
