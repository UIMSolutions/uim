...
template AttributeBoolean(string name, string clname = null) {
	...
	@safe @property O `~name~`(this O)(bool value = true) { if (value) _attributes["`~cl~`"]= "`~cl~`"; else _attributes.removeByKey("`~cl~`"); return cast(O)this; }
`;
}
...
template AttributeString(string name) {
	...
	@safe @property O `~name~`(this O)(string value) { if (value) _attributes["`~name~`"] = value; else _attributes.removeByKey("`~name~`"); return cast(O)this; }
`;
}
