...
class DBodyParserMiddleware { // }: IHttpMiddleware {
    ...
    this(Json[string] options = null) {
        auto updatedOptions = options.update["Json": true.toJson, "xml": false.toJson, "methods": null];
        if (options["Json"]) {
            this.addParser(
    ...
    // TODO protected Json[string] decodeJson(string bodyToDecode) {
    ...
    // TODO protected Json[string] decodeXml(string bodyToDecode) {
        try {
