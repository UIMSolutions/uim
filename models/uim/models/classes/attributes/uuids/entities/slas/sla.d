...
*****************************************************************************************************************/
module uim.models.classes.attributes.uuids.entities.slas.sla;    if (!super.initialize(initData)) {
      return false;
    }
...
unittest {
  ...
  assert(attribute.name == "SlaIdAttribute");
  assert(attribute.registerPath == "attributes.slaid");
