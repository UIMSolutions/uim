...
*****************************************************************************************************************/
module uim.oop.networks;UIMException
         ...
         */
            ...
            _connection = _getStreamSocketClient(
                ...
                to!int(configuration.get("timeout"]),
                    connectFlags,
                    context
            ); restore_error_handler(); if (_connection.isNull && (!errorNumber || !errorString)) {
                setLastError(errorNumber, errorString); throw new DSocketException(
                                                                    ...
                                                                    void enableCrypto(string type, string clientOrServer = "client", bool enable = true) {
                                                                        ...
                                                                        try {
                                                                            ...
                                                                            setLastError(null, anException.message());
                                                                                throw new DSocketException(anException
