    ...
    // #region READ
      // #region hasFiles()
        ...
        bool hasFiles(string[] aPath) {
          ...
          return (aPath.length > 1 
            ? hasFiles(aPath[0..$-1], aPath[$-1])
            : hasFiles(aNullArray, aPath[$-1]));  
        } 
      ...
      // #region countFiles()
        ...
        size_t countFiles(string[] aPath) {
          ...
          string[] aNullArray;
          return (aPath.length > 1 
            ? countFiles(aPath[0..$-1], aPath[$-1])
            : countFiles(aNullArray, aPath[$-1]));  
        }
      ...
      // #region files()
        ...
        IFile[] files(string[] aPath) {
          ...
          string[] aNullArray;
          return (aPath.length > 1 
            ? files(aPath[0..$-1], aPath[$-1])
            : files(aNullArray, aPath[$-1]));    
        }
    ...
    // #region CREATE
      // #region createFile
        ...
        IFile createFile(string[] aPath) {
          ...
          string[] aNullArray;
          return (aPath.length > 1 
            ? createFile(aPath[0..$-1], aPath[$-1])
            : createFile(aNullArray, aPath[$-1]));
        }
    ...
    // #region READ
      // #region existsFile
        ...
        bool existsFile(string[] aPath) {
          ...
          string[] aNullArray;
          return (aPath.length > 1 
            ? existsFile(aPath[0..$-1], aPath[$-1])
            : existsFile(aNullArray, aPath[$-1]));
        }
      ...
      // #region file
        ...
        IFile file(string[] aPath) {
          ...
          string[] aNullArray;
          return (aPath.length > 1 
            ? file(aPath[0..$-1], aPath[$-1])
            : file(aNullArray, aPath[$-1]));
        }
      ...
      // #region renameFile
        ...
        bool renameFile(string[] oldPathAndName, string newName) {
          ...
          return (oldPathAndName.length > 1 
            ? renameFile(oldPathAndName[0..$-1], oldName, newName)
            : renameFile(aNullArray, oldName, newName));
        }
    ...
    // #region DELETE
      // #region removeFile
        ...
        bool removeFile(string[] aPath) {
          ...
          string[] aNullArray;
          return (aPath.length > 1 
            ? removeFile(aPath[0..$-1], aPath[$-1])
            : removeFile(aNullArray, aPath[$-1]));
        }
