...
template InstanceConfigTemplate {
     ...
     *
     * ```
     * this.setConfig("key", aValue);
     * ```
     *
     * Setting a nested value:
     *
     * ```
     * this.setConfig("some.nested.key", aValue);
     * ```
     *
     ...
     */
    Json getConfig(string keyToGet = null, IData defaultData = null) {
        if (!_configInitialized) {
           _config = _defaultConfigData;
           _configInitialized = true;
        }
     ...
     */
    protected void _configWrite(string[] keyToWrite, Json aValue, string|bool merge = false) {
    ...
    protected void _configDelete(string keyToDelete) {
        if (!keyToDelete.has(".")) {
            unset(configuration.data(keyToDelete));
