...
class DError {
  ...
  /**
    * Constructor
    *
    * aCode - The UIM error code constant
    * aMessage - The error message.
    * aFile - The filename of the error.
    * aLine - The line number for the error.
    * traceData - The backtrace for the error.
    */
  this(
      int aCode,
      string aMessage,
  ...
  void initialize(/* DC onfigurationValue configSettings= null */) {
