...
class DError : UIMObject, IError {
  ...
  enum ERRORS : ulong {
    ...
    CORERRORS.ERROR = 16, // Fatal errors that occur during D's initial startup. This is like an ERRORS.ERROR, except it is generated by the core of D.
    CORERRORS.WARNING = 32, // Warnings (non-fatal errors) that occur during D's initial startup. This is like an ERRORS.WARNING, except it is generated by the core of D.
    COMPILERRORS.ERROR = 64, // Fatal compile-time errors. This is like an ERRORS.ERROR, except it is generated by the Zend Scripting Engine.
    COMPILERRORS.WARNING = 128, // Compile-time warnings (non-fatal errors). This is like an ERRORS.WARNING, except it is generated by the Zend Scripting Engine.
    USER_ERROR = 256, // User-generated error message. This is like an ERRORS.ERROR, except it is generated in D code by using the D function trigger_error().
    USER_WARNING = 512, // User-generated warning message. This is like an ERRORS.WARNING, except it is generated in D code by using the D function trigger_error().
    USER_NOTICE = 1024, // User-generated notice message. This is like an ERRORS.NOTICE, except it is generated in D code by using the D function trigger_error().
    ...
    RECOVERABLERRORS.ERROR = 4096, // Catchable fatal error. It indicates that a probably dangerous error occurred, but did not leave the Engine in an unstable state. If the error is not caught by a user defined handle (see also set_error_handler()), the application aborts as it was an ERRORS.ERROR.
  ...
  override bool initialize(Json[string] initData = null) {
    ...
    _levelMap = _levelMap.merge([
      ...
      ERRORS.CORERRORS.WARNING: "warning",
      ERRORS.COMPILERRORS.ERROR: "error", // ERRORS.COMPILERRORS.ERROR - 
      ERRORS.COMPILERRORS.WARNING: "warning", // ERRORS.COMPILERRORS.WARNING
