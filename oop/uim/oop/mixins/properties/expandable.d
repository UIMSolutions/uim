...
template XString(string name) {
	...
	@safe O "~name~"(this O)(string[] addValues...) { this."~name~"(addValues); return cast(DO)this; }
	@safe O "~name~"(this O)(string[] addValues) { _"~name~" ~= addValues.join(); return cast(DO)this; }

	@safe O clear"~name.capitalize~"(this O)() { _"~name~" = null; return cast(DO)this; }	
	";
}
...
template XStringArray(string name) {
	...
	@safe O "~name~"(this O)(string[] values...) { this."~name~"(values); return cast(DO)this; }
	@safe O "~name~"(this O)(string[] values) { _"~name~" ~= values; return cast(DO)this; }
	
	@safe O remove"~Name~"(this O)(string[] values...) { this.remove"~Name~"(values); return cast(DO)this; }	
	@safe O remove"~Name~"(this O)(string[] values) {
		foreach(value; values) _"~name~" = _"~name~".sub(value); return cast(DO)this; }	
	
	@safe O clear"~Name~"(this O)() { _"~name~" = null; return cast(DO)this; }	
	";
}
version(test_uim_oop) { unittest {
...
template XStringAA(string name) {
	...
	@safe O "~name~"(this O)(string key, string value) { _"~name~"[key] = value; return cast(DO)this; }
	@safe O "~name~"(this O)(STRINGAA addValues) { foreach(kv; addValues.byKeyValue) _"~name~"[kv.key] = kv.value; return cast(DO)this; }
	
	@safe O remove"~Name~"(this O)(string[] values...) { this.remove(values); return cast(DO)this; }	
	@safe O remove"~Name~"(this O)(string[] values) { foreach(value; values) _name = _"~name~".remove(value); return cast(DO)this; }	
...
template XPropertyAA(string key, string value, string name) {
	...
	@safe O `~name~`(this O)(`~datatype~` values) { _`~name~` = _`~name~`.add(values); return cast(DO)this; }

	@safe O `~name~`Init(this O)(`~key~`[] keys, `~value~` value) { foreach(k; keys) _`~name~`[k] = value; return cast(DO)this; }
	@safe O `~name~`Add(this O)(`~datatype~` values) { _`~name~` = _`~name~`.add(values); return cast(DO)this; }
	@safe O `~name~`Sub(this O)(`~datatype~` values) { _`~name~` = _`~name~`.sub(values); return cast(DO)this; }

	@safe O remove`~Name~`(this O)(`~key~`[] keys...) { return this.remove`~Name~`(keys); return cast(DO)this; }
	@safe O remove`~Name~`(this O)(`~key~`[] keys) { _`~name~` = _`~name~`.sub(keys); return cast(DO)this; }

	@safe O clear`~Name~`(this O)() { _`~name~` = _`~name~`.clear; return cast(DO)this; }
`;
}
version(test_uim_oop) { unittest {
...
template XPropertyArray(string datatype, string name) {
	...
	@safe O `~name~`(this O)(`~datatype~`[] values...) { _`~name~` = _`~name~`.add(values); return cast(DO)this; }
	@safe O `~name~`(this O)(`~datatype~`[] values, bool unique = false) { _`~name~` = _`~name~`.add(values, unique); return cast(DO)this; }
	
	@safe O remove`~Name~`(this O)(`~datatype~`[] values...) { remove`~Name~`(values); return cast(DO)this; }
