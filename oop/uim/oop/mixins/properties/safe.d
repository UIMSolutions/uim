...
auto SPropertySet(string dataType, string propertyName) { return "@safe @property O "~propertyName~"(this O)("~dataType~" value) { _"~propertyName~" = value; return cast(DO)this; }"; }
...
template SProperty_getset(string dataType, string propertyName, bool getter = false, bool setter = false) { 
	const char[] SProperty_set = "@safe @property O "~propertyName~"(this O)("~dataType~" value) { _"~propertyName~" = value; return cast(DO)this; }";
}
version(test_uim_oop) { unittest {
	class DTest{ int _a = 1; mixin(SProperty_set!("int", "a")); }
 	assert((new Test).a(1)._a == 1);
