 ...
 *
 * - `beforeRules(IEvent event, DORMEntity entity, Json[string] options, operation)`
 ...
 *
 * - `afterRules(IEvent event, DORMEntity entity, Json[string] options, bool result, operation)`
 *  Fired after the rules have been checked on the entity. By stopping this event,
 *  you can return the final value of the rules checking operation.
 *
 * - `beforeSave(IEvent event, DORMEntity entity, Json[string] options)`
 ...
 *
 * - `afterSave(IEvent event, DORMEntity entity, Json[string] options)`
 *  Fired after an entity is saved.
 *
 * - `beforeremoveKey(IEvent event, DORMEntity entity, Json[string] options)`
 *  Fired before an entity is deleted. By stopping this event you will abort
 *  the delete operation.
 *
 * - `afterremoveKey(IEvent event, DORMEntity entity, Json[string] options)`
