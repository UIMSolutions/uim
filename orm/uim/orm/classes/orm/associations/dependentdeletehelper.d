...
class DependentDeleteHelper {
     ...
     * @return bool Success.
     */
    bool cascadeDelete(DORMAssociation anAssociation, IEntity anEntity, STRINGAA someOptions = null) {
        if (!anAssociation.getDependent()) {
            return true;
        }
        table = anAssociation.getTarget();
        /** @psalm-suppress InvalidArgument */
        foreignKey = array_map([anAssociation, "aliasField"], (array)anAssociation.getForeignKey());
