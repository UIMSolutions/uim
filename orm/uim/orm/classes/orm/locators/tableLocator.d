...
class TableLocator : AbstractLocator : ILocator
{
     ...
     */
    function get(string anAliasName, STRINGAA someOptions = null): Table
    {
        /** @var DORMTable */
    ...
    protected function createInstance(string anAliasName, STRINGAA someOptions) {
     ...
     * @return string|null
     */
    protected Nullable!string _getClassName(string anAliasName, STRINGAA someOptions = null) {
        if (empty(options["className"])) {
            options["className"] = alias;
        }
     ...
     * @return DORMTable
     */
    protected function _create(STRINGAA someOptions): Table
    {
        /** @var DORMTable */
