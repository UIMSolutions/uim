 ...
 * - `afterMarshal(IEvent event, IEntity anEntity, ArrayObject options)`
 * - `buildValidator(IEvent event, Validator validator, string aName)`
 * - `buildRules(RulesChecker rules)`
 * - `beforeRules(IEvent event, IEntity anEntity, ArrayObject options, string operation)`
 * - `afterRules(IEvent event, IEntity anEntity, ArrayObject options, bool result, string operation)`
 ...
 */
class DORMTable : IRepository, IEventListener, IEventDispatcher, ValidatorAwareInterface {
    ...
    // Connection instance
    protected DDBConnection _connection;

    /**
     * The schema object containing a description of this table fields
     *
     * @var DDBSchema\TableISchema|null
     */
    protected DDBSchema _schema;
    ...
    protected DORMAssociationCollection _associations;

    // BehaviorRegistry for this table
    protected DORMBehaviorRegistry _behaviors;

    //The name of the class that represent a single row for this table
    protected string _entityClasName;
     ...
     * - entityClassName: The fully namespaced class name of the entity class that will
     *   represent rows in this table.
     * - schema: A DORMdatabases.Schema\TableISchema object or an array that can be
     *   passed to it.
     ...
     *
     * @param DORMdatabases.Connection connection The connection instance
     * @return this
     */
     ...
     *
     * @return DORMdatabases.Connection
     */
    function getConnection(): Connection
    {
        if (!_connection) {
            /** @var DDBConnection connection */
            connection = ConnectionManager::get(defaultConnectionName());
            _connection = connection;
        }
     ...
     *
     * @return DORMdatabases.Schema\TableISchema
     */
     ...
     *
     * @param DORMdatabases.Schema\TableISchema|array schema Schema to be used for this table
     * @return this
     */
     ...
     *
     * ```
     * protected function _initializeSchema(DORMdatabases.Schema\TableISchema schema) {
     *  schema.setColumnType("preferences", "json");
     *  return schema;
     * }
     * ```
     *
     * @param DORMdatabases.Schema\TableISchema schema The table definition fetched from database.
     * @return DORMdatabases.Schema\TableISchema the altered schema
     */
    ...
    string[] getDisplayField() {
        if (_displayFields == null) {
            schema = this.getSchema();
            _displayFields = this.getPrimaryKeys();
     ...
     *
     * @return string
     * @psalm-return class-string<DORMDatasource\IEntity>
     */
    string getEntityClass() {
        if (!_entityClass) {
            ...
            /** @var class-string<DORMDatasource\IEntity>|null class */
     ...
     * @throws DORMexceptions.MissingEntityException when the entity class cannot be found
     * @return this
     */
    function setEntityClass(string aName) {
        /** @psalm-var class-string<DORMDatasource\IEntity>|null */
        class = App::className(name, "Model/Entity");
        if (class == null) {
            throw new MissingEntityException([name]);
        }
     ...
     * @see DORMBehavior
     */
    function addBehavior(string aName, STRINGAA someOptions = null) {
     ...
     *
     * @return DORMBehaviorRegistry The BehaviorRegistry instance.
     */
     ...
     * @return this
     * @see DORMTable::belongsTo()
     * @see DORMTable::hasOne()
     * @see DORMTable::hasMany()
     * @see DORMTable::belongsToMany()
     */
     ...
     * @return DORMassociations.BelongsTo
     */
    function belongsTo(string associated, STRINGAA someOptions = null): BelongsTo
    {
        options += ["sourceTable": this];

        /** @var DORMassociations.BelongsTo association */
     ...
     * uniquely identify the association
     * @param array<string, mixed> options list of options to configure the association definition
     * @return DORMassociations.HasOne
     */
    bool hasOne(string associated, STRINGAA someOptions = null): HasOne
    {
        options += ["sourceTable": this];

        /** @var DORMassociations.HasOne association */
     ...
     * uniquely identify the association
     * @param array<string, mixed> options list of options to configure the association definition
     * @return DORMassociations.HasMany
     */
    bool hasMany(string associated, STRINGAA someOptions = null): HasMany
    {
        options += ["sourceTable": this];

        /** @var DORMassociations.HasMany association */
     ...
     * uniquely identify the association
     * @param array<string, mixed> options list of options to configure the association definition
     * @return DORMassociations.BelongsToMany
     */
    function belongsToMany(string associated, STRINGAA someOptions = null): BelongsToMany
    {
        options += ["sourceTable": this];

        /** @var DORMassociations.BelongsToMany association */
     ...
     * @return DORMQuery The query builder
     */
    function find(string type = "all", STRINGAA someOptions = null): Query
    {
     ...
     *
     * @param DORMQuery query The query to find with
     * @param array<string, mixed> options The options to use for the find
     * @return DORMQuery The query builder
     */
    function findAll(Query query, STRINGAA someOptions): Query
    {
        return query;
    }
     ...
     * of calling `primaryKeys` and `displayFields` respectively in this table:
     *
     * ```
     * table.find("list", [
     *  "keyField": "name",
     ...
     * @return DORMQuery The query builder
     */
    function findList(Query query, STRINGAA someOptions): Query
    {
        options += [
        ...
        return query.formatResults(function (results) use (options) {
            /** @var DORMcollections.ICollection results */
     ...
     * @return DORMQuery The query builder
     */
    function findThreaded(Query query, STRINGAA someOptions): Query
    {
        options += [
            "keyField": this.getPrimaryKeys(),
     ...
     */
    protected array _setFieldMatchers(STRINGAA someOptions, array keys) {
     ...
     * ```
     *
     * @param mixed primaryKeys primary key value to find
     * @param array<string, mixed> options options accepted by `Table::find()`
     * @return DORMDatasource\IEntity
     * @throws DORMDatasource\exceptions.RecordNotFoundException if the record with such id
     * could not be found
     * @throws DORMDatasource\exceptions.InvalidPrimaryKeyException When primaryKeys has an
     *      incorrect number of elements.
     * @see DORMdatasources.IRepository::find()
     * @psalm-suppress InvalidReturnType
     */
    function get(primaryKeys, STRINGAA someOptions = null): IEntity
    {
        if (primaryKeys == null) {
        ...
        if (count(key) != count(primaryKeys)) {
        ...
        conditions = array_combine(key, primaryKeys);

        cacheConfig = options["cache"] ?? false;
        cacheKey = options.get("key", false);
     ...
     * parameter can be a callable that takes the Query as the argument, or a DORMQuery object passed
     ...
     *
     * @param DORMQuery|callable|array search The criteria to find existing
     ...
     * @return DORMDatasource\IEntity An entity.
     * @throws DORMexceptions.PersistenceFailedException When the entity couldn"t be saved
     */
    IEntity findOrCreate(search, ?callable callback = null, options = null) {
     ...
     *
     * @param DORMQuery|callable|array search The criteria to find an existing record by, or a callable tha will
     *   customize the find query.
     * @param callable|null callback A callback that will be invoked for newly
     *   created entities. This callback will be called *before* the entity
     *   is persisted.
     * @param array<string, mixed> options The options to use when saving.
     * @return DORMDatasource\IEntity|array An entity.
     * @throws DORMexceptions.PersistenceFailedException When the entity couldn"t be saved
     * @throws \InvalidArgumentException
     */
    protected function _processFindOrCreate(search, ?callable callback = null, options = null) {
        ...
        if (options["defaults"] && is_array(search)) {
            accessibleFields = array_combine(search.keys, array_fill(0, count(search), true));
     ...
     *
     * @param DORMQuery|callable|array search The criteria to find existing records by.
     * @return DORMQuery
     */
     ...
     * ```
     *
     * @param DORMDatasource\IEntity anEntity the entity to be saved
     * @param DORMSaveOptionsBuilder|\ArrayAccess|STRINGAA someOptions The options to use when saving.
     * @return DORMDatasource\IEntity|false
     * @throws DORMexceptions.RolledbackTransactionException If the transaction is aborted in the afterSave event.
     */
    function save(IEntity anEntity, options = null) {
     ...
     * @see DORMTable::save()
     */
    function saveOrFail(IEntity anEntity, options = null): IEntity
    {
     ...
     * @throws DORMexceptions.RolledbackTransactionException If the transaction
     *   is aborted in the afterSave event.
     */
    protected function _processSave(IEntity anEntity, ArrayObject options) {
     ...
     *   is aborted in the afterSave event.
     */
    protected bool _onSaveSuccess(IEntity anEntity, ArrayObject options) {
        ...
        if (options["atomic"] && !this.getConnection().inTransaction()) {
            throw new RolledbackTransactionException(["table": class]);
        }
     ...
     *
     * @param DORMDatasource\IEntity anEntity the subject entity from were data was extracted
     ...
     */
    protected function _insert(IEntity anEntity, array data) {
        ...
        if (count(primary) > 1) {
            ...
            foreach (primary as k: v) {
                if (!isset(data[k]) && empty(schema.getColumn(k)["autoIncrement"])) {
                    ...
                    msg ~= sprintf(
                        "Got (%s), expecting (%s)",
                        implode(", ", filteredKeys + entity.extract(primary.keys)),
                        implode(", ", primary.keys)
                    );
                    throw new RuntimeException(msg);
                }
            }
        ...
        statement = this.query().insert(data.keys)
            .values(data)
            .execute();
     ...
     */
    protected function _update(IEntity anEntity, array data) {
        primaryColumns = (array)this.getPrimaryKeys();
        primaryKeys = entity.extract(primaryColumns);

        data = array_diff_key(data, primaryKeys);
        if (empty(data)) {
            return entity;
        }
        ...
        if (count(primaryColumns) == 0) {
            ...
            table = this.getTable();
            message = "Cannot update `entityClassName`. The `table` has no primary key.";
            throw new InvalidArgumentException(message);
        }
     ...
     * error.
     *
     * @param iterable<DORMDatasource\IEntity> entities Entities to save.
     * @param DORMSaveOptionsBuilder|\ArrayAccess|STRINGAA someOptions Options used when calling Table::save() for each entity.
    ...
    protected function _saveMany(iterable entities, options = null): iterable
    {
        ...
        cleanupOnFailure = void (entities) use (&isNew) {
            /** @var array<DORMDatasource\IEntity> entities */
        ...
        /** @var DORMdatasources.IEntity|null failed */
        failed = null;
        try {
            this.getConnection()
        ...
        cleanupOnSuccess = function (IEntity anEntity) use (&cleanupOnSuccess) {
            entity.clean();
            entity.setNew(false);

            foreach (entity.toArray().keys as field) {
     ...
     *
     * @param DORMDatasource\IEntity anEntity The entity to remove.
     ...
     * error.
     *
     * @param iterable<DORMDatasource\IEntity> entities Entities to delete.
     * @param \ArrayAccess|STRINGAA someOptions Options used when calling Table::save() for each entity.
     ...
     *
     * @param DORMDatasource\IEntity anEntity The entity to delete.
     ...
     * @param DORMQuery query The query object to apply the finder options to.
     ...
     * @uses findThreaded()
     */
    function callFinder(string type, Query query, STRINGAA someOptions = null): Query
    {
    ...
    function __call(method, args) {
        ...
        throw new BadMethodCallException(
            sprintf("Unknown method '%s' called on %s", method, class)
        );
    }
     ...
     * @return DORMDatasource\IEntity
     * @see DORMMarshaller::one()
     */
    IEntity newEntity(array data, STRINGAA someOptions = null) {
     ...
     * @param array<string, mixed> options A list of options for the object hydration.
     * @return DORMDatasource\IEntity
     * @see DORMMarshaller::merge()
     */
    function patchEntity(IEntity anEntity, array data, STRINGAA someOptions = null): IEntity
    {
        options["associated"] = options["associated"] ?? _associations.keys();
        marshaller = this.marshaller();
     ...
     */
    bool validateUnique(value, STRINGAA someOptions, ?array context = null) {
        if (context == null) {
            context = options;
        }
        entity = new Entity(
        ...
        class = IS_UNIQUE_CLASS;
        /** @var DORMrules.IsUnique rule */
     ...
     * {@inheritDoc}
     *
     * @param DORMRulesChecker rules The rules object to be modified.
     * @return DORMRulesChecker
     */
