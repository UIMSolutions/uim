    ...
    auto creditCard(
        ...
        if (errorMessage.isNull) {
            errorMessage = !_useI18n
                ...
                .format(mytypeEnumeration) : allowedTypeOfCards == "all"
                ? `__d(
                        "uim",
                        "The provided value must be a valid credit card number of any type"
                    )` : `__d(
        ...
        if (errorMessage.isNull) {
            errorMessage = !_useI18n
                ? "The provided value must not be equal to '%s'".format(
                    value) : `__d("uim", "The provided value must not be equal to '{0}'", value)`;
        }
 ...
 */
    ...
    Json[string] debugInfo() {
        ...
        return info // TODO .set("_presenceMessages", _presenceMessages)
        // .set("_allowEmptyMessages", _allowEmptyMessages.toJson)
        // .set("_allowEmptyFlags", _allowEmptyFlags.toJson)
        .set("_useI18n", _useI18n) /* .set("_stopOnFailure", _stopOnFailure)
