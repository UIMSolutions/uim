module uim.views.classes.forms.contextfactorys;
...
class ContextFactory {
    // Context providers.
    protected array<string, array> myproviders = [];
            ...
            [
                ...
                "callable": auto (myrequest, mydata) {
                    ...
                    if (is_iterable(mydata["entity"])) {
                        mypass = (new Collection(mydata["entity"])).first() !isNull;
                        if (mypass) {
                            return new EntityContext(mydata);
                        } else {
