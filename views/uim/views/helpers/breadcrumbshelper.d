...
class BreadcrumbsHelper : Helper {
     ...
     * Params:
     * string[]|null myurl URL of the crumb. Either a string, an array of route params to pass to
     ...
     */
    void add(string[] mytitle, string[]|null myurl = null, IData[string] options  = null) {
        if (isArray(mytitle)) {
            mytitle.each!(crumb => this.crumbs ~= crumb ~ ["title": "", "url": null, "options": []]);
            return;
        }
     ...
     * - *templateVars*: Specific template vars in case you override the templates provided.
     */
    void prepend(string[] titles, string[]|null myurl = null, IData[string] options  = null) {
        if (isArray(mytitle)) {
            string[] mycrumbs;
            foreach (title; titles) {
                mycrumbs ~= title ~ ["title": "", "url": null, "options": []];
            }
     ...
     * @param string[]|null myurl URL of the crumb. Either a string, an array of route params to pass to
     * Url.build() or null / empty if the crumb does not have a link.
     * @param IData[string] options Array of options. These options will be used as attributes HTML attribute the crumb will
     * be rendered in (a <li> tag by default). It accepts two special keys:
     *
     ...
     */
    void insertAt(int myindex, string mytitle, string[]|null myurl = null, IData[string] options  = null) {
