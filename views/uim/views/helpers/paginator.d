...
class DPaginatorHelper : DHelper {
    ...
    void options(Json[string] optionsForLinks = null) {
        if (options.hasKey("paging")) {
            configuration.set("params", options.get("paging"]); options.removeKey("paging");
        }
            ...
            int total() {
                ...
                protected string sortDir() {
                    string mydir =  /* (string) */ this.param(
                            "direction").lower; return mydir == "desc" ? "desc" : "asc";
                }
                ...
                protected string _toggledLink(string linkText, bool isEnabled, Json[string] options, Json[string] templates) {
                    auto mytemplate = templates["active"]; if (!isEnabled) {
                        linkText = options.get("disabledTitle"); mytemplate = templates["disabled"];
                    }
                    if (!isEnabled && linkText == false) {
                        return null;}
                        Json linkText = options.get("escape") ? htmlAttributeEscape(
                            linkText) : linkText; contentTemplater = this.templater();
                            mynewTemplates = options.get("templates") ?  ? false; if (
                                mynewTemplates) {
                                                    ...
                                                    string sort(string key, string[] linkTitle = null, Json[string] options = null) {
                                                        ...
                                                        auto url = options.shift("url");
                                                            if (linkTitle.isEmpty) {
                                                                ...
                                                                stringmydefaultDir = options.getString("direction", "asc")
                                                                    .lower; options.removeKey(
                                                                        "direction");
     ...
     */
                                                        string generateUrl(
                                                            ...
                                                            urlOptions.merge([
                                                                "escape": true,
                                                                "fullBase": false,
                                                            ]); return _Url.build(this.generateUrlParams(
                                                        ...
                                                        Json[string] generateUrlParams(Json[string] options = null, Json[string] url = null) {
                                                            ...
                                                            if (
                                                                ...
                                                                .lower
                                                                    ...
                                                                    null)); options.set("sort", options.get(
                                                                    "direction"));
                                                                }
     ...
     */
                                                                        ...
                                                                        Json[string] optionsForNumbers = null) {
                                                                            ...
                                                                            if (updatedoptions.get(
                                                                                "modulus"] == true && params.getLong(
                                                                                "pageCount") > updatedoptions.get(
                                                                                "modulus"]) {
